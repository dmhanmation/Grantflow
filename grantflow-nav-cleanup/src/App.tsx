...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans flex flex-col overflow-x-hidden w-full max-w-full">
      ...
      {/* Preview banner: always offers a way back to Admin when viewing as a non-admin.
          Prevents getting stuck after using Switch Staff Perspective. */}
        ...
        <div className="bg-amber-500 text-white">
          <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between gap-3">
            <span className="text-xs font-bold truncate">
              Previewing as {currentUser.fullName} ({currentUser.role}). You are not viewing as Admin.
            </span>
            <button
              type="button"
              onClick={() => {
