...
export interface OrgProfile {
  ...
  // Tracks where each multi-value field's entries came from: 'derived' (from an uploaded
  // document), 'added' (entered by a person), or 'verified' (a derived value a person confirmed).
  // Keyed by field id, then by value. Optional and additive; absence means no provenance recorded.
