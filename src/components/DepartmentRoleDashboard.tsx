...
export const DepartmentRoleDashboard: React.FC<DepartmentRoleDashboardProps> = ({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        <div className="flex flex-wrap items-center bg-slate-100 p-1 rounded-xl gap-1 shrink-0">
          ...
          >
            ...
            <span>Applications Under Coordination (Lead)</span>
          </button>
        </div>
      </div>
      ...
      {/* VIEW 2: DEPARTMENT HEAD VIEW ("Department Responsibilities") */}
      {roleView === 'department_head' && (
      ...
      {/* VIEW 3: OFFICER VIEW ("Proposal Tasks") */}
      {roleView === 'officer' && (
        <div className="space-y-6 animate-in fade-in duration-200">
      ...
      {/* VIEW 4: PROPOSAL LEAD VIEW ("Departmental Task Review & Applications Under Coordination") */}
      {roleView === 'proposal_lead' && (
        <div className="space-y-6 animate-in fade-in duration-200">
