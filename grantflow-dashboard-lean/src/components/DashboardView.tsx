...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      {/* PERSONALIZED USER DASHBOARD (staff only — redundant with nav and Org Profile for admins) */}
      {!isAdmin && currentUser && orgProfile && (
      ...
      {/* PROPOSAL ACCOUNTABILITY & BOTTLENECK RADAR (staff only; admins see counts in the KPIs) */}
      {!isAdmin && (
      ...
      {/* AGENTIC DOCUMENT EXPIRY & COMPLIANCE RADAR (staff only; admins see the badge in the header) */}
      {!isAdmin && (
